...
if __name__ == '__main__':
    ...
    cosin_rast = rank_documents(text, documents)
    pirs_koef = rank_documents(text, documents, sim_func=pearson)
    print(documents[cosin_rast[0][1]])
    print(documents[pirs_koef[0][1]])
    
    
    if cosin_rast[0][1] == pirs_koef[0][1]:
        print('True')
    else:
        print('False')
...
# За документот на влез, најдете го најсличниот документ од тренинг множеството користејќи косинусно растојание и
#  пирсонов коефициент на корелација. На излез да се испечатат двата документи (во првата линија документот добиен 
# со косинусно растојание и во втората линија документот добиен со пирсонов коефициент на корелација). На крај да се 
# испечати „true“ доколку на двата начини се добива истиот документ. Во спротивно да се испечати „false“.
