...
if __name__ == "__main__":
    ...
    classification = classify(test_case, t)
    print(maximum(classification))

    #Po azbuchen red pravime sorted(list) ili list.sort() na keys dokolku ima potreba


# //Да се изгради дрво на одлука со даденото множество за тренирање и да се испечати класата
# која се класифицира за дадениот тест примерок, така што таа ќе ја печати само класата која
# ја предвидува (а не речник). Притоа да се провери дали во листот има повеќе од една класа.
# Ако има само една класа тогаш се предвидува истата, но ако има повеќе од една треба да се
# испечати таа со најголем број на инстанци. Ако во листот има неколку класи со ист број на
# инстанци да се предвиди првата класа по азбучен ред.